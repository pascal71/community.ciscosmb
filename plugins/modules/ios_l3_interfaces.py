...
- name: Merge provided configuration with device configuration
  community.ciscosmb_l3_interfaces:
    config:
...
from ansible_collections.community.ciscosmb.plugins.module_utils.network.ios.argspec.l3_interfaces.l3_interfaces import (
    L3_interfacesArgs,
)
from ansible_collections.community.ciscosmb.plugins.module_utils.network.ios.config.l3_interfaces.l3_interfaces import (
    L3_interfaces,
)
